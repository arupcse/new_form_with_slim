...
<head>
	...
	<title>
		<?php echo $window_title_admin;?>
	</title>

	<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="robots" content="<?php echo $meta_robots_admin;?>"/>
	<meta name="description" content="<?php echo $meta_description_admin;?>" />
	<meta name="keywords" content="<?php echo $meta_keywords_admin;?>" />
</head>
